...
LOGS = HERE / "logs"
STATE_FILE = HERE / "state_hr8_ar4_extra_seeds.json"
EVENTS_FILE = HERE / "events_hr8_ar4_extra_seeds.jsonl"
...
class Job:
    ...
    def name(self) -> str:
        ...
        return f"qwen25_05b_hidden_hr{HIDDEN_RANK}_seed{self.seed}"

    @property
    def variant(self) -> str:
        return "affine_input_lm_head_plus_hidden_lora" if self.mergeable else "hidden_lora"
...
JOBS = [Job(seed, mergeable=False) for seed in SEEDS] + [Job(seed, mergeable=True) for seed in SEEDS]
