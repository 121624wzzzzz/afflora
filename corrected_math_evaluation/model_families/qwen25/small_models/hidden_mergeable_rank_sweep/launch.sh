...
EXP=corrected_math_evaluation/model_families/qwen25/small_models/hidden_mergeable_rank_sweep
...
echo "launched small mergeable rank sweep: orchestrator=$ORCH_PID monitor=$MON_PID"
wait "$ORCH_PID"
STATUS=$?
wait "$MON_PID" || true
exit "$STATUS"
