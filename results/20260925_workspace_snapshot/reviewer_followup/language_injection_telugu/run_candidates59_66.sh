#!/usr/bin/env bash
# Final early-energy + dual-domain-KL treatment on the matched Telugu task.
set -euo pipefail
...
for gpu in {0..7}; do
  seed=$((59 + gpu)); control="qwen25_15b_telugu_mc_tied_l0_anchor0p1_sd${seed}"; name="qwen25_15b_telugu_mc_tied_l100early400_anchor0p1_dualkl0p05_sd${seed}"
...
wait
echo "$(date -Is) Telugu candidates 59--66 complete"
