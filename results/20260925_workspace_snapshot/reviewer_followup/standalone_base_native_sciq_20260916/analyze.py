...
def main():
    ...
    result['reference_note']='Earlier independently trained seeds3002–3006 on the same questions, but with ChatML/im_end rather than native completion/EOS. Context only: initialization stage and input/stop protocol both differ; not a paired or stage-only causal comparison.'
