...
ROOT=Path(__file__).resolve().parent/'qwen35_fixed_multiscale_20260920'
...
def main():
 ...
 for ax,task in zip(axes,['wikisql','trec50']):
  ...
  ax.set_yticks(range(4),['0.8B','2B','4B','9B'])
 ...
 fig.text(.5,.02,'Five paired training seeds; adjusted 95% t intervals. All four sizes: family 16; common fixed numerical policy.\nIntervals condition on fixed data and selected configurations; no joint data/tuning uncertainty.',ha='center',fontsize=8)
