...
def build(spec):
    ...
    assert arm in ['base','hidden','input','output','both','hidden_both','hidden_output','hidden_budget']
    ...
    for where,present in [('input',arm in ['input','both','hidden_both']),('output',arm in ['output','both','hidden_both','hidden_output'])]:
    ...
    d=model.config.hidden_size;expect=(33*d if arm in ['input','both','hidden_both'] else 0)+(32*d if arm in ['output','both','hidden_both','hidden_output'] else 0)
